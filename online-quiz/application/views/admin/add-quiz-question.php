                          ...
                          <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                   <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" maxlength="250" name="option_1"></textarea>
                               ...
                               <div class="col-sm-6">
                                   <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" maxlength="250" name="option_2"></textarea>
                             ...
                             <div class="row clearfix">
                                <div class="col-sm-6">
                                   <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" maxlength="250" name="option_3"></textarea>
                               ...
                               <div class="col-sm-6">
                                   <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control no-resize" maxlength="250" name="option_4"></textarea>
                          ...
                          <div class="row clearfix">
                                <div class="col-sm-9">
                                  <div class="form-group">
                                        Correct Answer :
                                        <input type="radio" name="answer" value="option_1" id="option_1" class="with-gap" >
                                        <label for="option_1">Option 1</label>
    
                                        <input type="radio" name="answer" value="option_2" id="option_2" class="with-gap" >
                                        <label for="option_2" class="m-l-20">Option 2</label>
                                        
                                        <input type="radio" name="answer" value="option_3" id="option_3" class="with-gap" >
                                        <label for="option_3" class="m-l-20">Option 3</label>
                                        
                                        <input type="radio" name="answer" value="option_4" id="option_4" class="with-gap" >
